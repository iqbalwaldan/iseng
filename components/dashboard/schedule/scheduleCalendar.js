  ...
  function ScheduleCalendar() {
    ...
    const renderCalendar = () => {
        ...
        for (let i = 1; i <= endDate; i++) {
          ...
          days.push(
            <div
              className={`text-center flex items-center justify-center text-base 2xl:text-xl font-semibold border-[2px] border-primary-base text-primary-base px-2 py-1 rounded-[4px] cursor-pointer hover:bg-neutral-20 hover:text-primary-base`}
            >
    ...
    return (
      <div className="w-full">
        <div className="flex items-center justify-between mb-4">
            <h1 className="text-xl font-semibold text-neutral-90">{format(currentDate, "MMMM")}</h1>
