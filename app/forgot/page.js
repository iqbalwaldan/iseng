...
export default function Forget() {
  ...
  const renderImages = () => {
    return slides.map((slide, slideIndex) => (
      ...
      >
        <Image src={slide.url} alt={`Slide ${slideIndex}`} width={500} height={500} />
      </div>
    ));
  };
    ...
    <div className="flex flex-col md:flex-row">
      ...
      <div className="md:w-register-right w-full h-full">
        <div className="bg-white p-6 md:px-32 md:py-40">
          ...
          <h1 className="font-bold text-4xl text-neutral-80 mb-4">Forgot Password</h1>
          <p className="text-base font-light text-neutral-70">
            We will send a password reset link via your email. Please enter the email that has been registered
          </p>
